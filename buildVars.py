...
Pipes terminal text into Notepad for easier screen-reader navigation, with Claude Code-aware attention-point and regex-nav gestures."""),
	...
	addon_url="https://github.com/dennischenfeng/nvda-plain-view",
	# URL for the add-on repository where the source code can be found
	addon_sourceURL="https://github.com/dennischenfeng/nvda-plain-view",
...
pythonSources: list[str] = ["addon/globalPlugins/plain_view/*.py"]
