...
Pipes terminal text into Notepad for easier screen-reader navigation, with quickjump-style bookmarks for jumping around the dumped content."""),
	...
	"addon_url": "https://github.com/dennisfeng2/nvda-plain-view",
	# URL for the add-on repository where the source code can be found
	"addon_sourceURL": "https://github.com/dennisfeng2/nvda-plain-view",
...
pythonSources = ["addon/globalPlugins/plain_view/*.py"]
